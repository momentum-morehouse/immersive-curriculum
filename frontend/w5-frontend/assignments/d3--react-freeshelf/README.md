...
On day one, you can hard code your data while you get your components working. By day two, you should be retrieving data using AJAX. You can use [JSON Server](https://github.com/typicode/json-server) to GET and POST data.
