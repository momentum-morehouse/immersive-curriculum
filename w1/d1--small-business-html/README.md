...
Your task is to build a three-page website for a small business, Lazy River Nursery & Garden Supply. The three pages are:
...
Under the picture, there should be a navigation list (using the <nav> element) with three links pointing to the homepage, the "currently in stock" page, and the hours and location page. This navigation list should be under the header for each page.
